          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="animate-fade-in-up animation-delay-200">
                ...
                <h4 className="text-xl md:text-2xl font-bold mb-2 bg-gradient-to-r from-cyan-200 via-blue-400 to-teal-200 bg-clip-text text-transparent">
                  Software Developer
                </h4>
              ...
              <div className="space-y-4 animate-fade-in-up animation-delay-600">
                <p className="space-y-2 text-lg">
                  I have around 6 years of experience in software development,
                  specializing in both back-end and front-end features, and 4
                  years of experience as Mobile Application Developer.
                </p>
                <p className="space-y-2 text-lg">
                  I've worked on various projects, including web applications,
                  mobile apps, and large-scale data systems. I possess a solid
                  understanding of requirement specifications and best practices
              ...
              <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up animation-delay-1000">
                ...
                <a
                  href="/resume/hninhninwai_fullstack.pdf"
